...
public class AuthTokenFilterTest {
    ...
    @Test
    void shouldFilterWithValidJwtToken() throws IOException, ServletException {
        String jwt = "validJwt";
    ...
    @Test
    void shouldFilterWithInvalidJwtToken() throws IOException, ServletException {
    ...
    @Test
    void shouldFilterWithMissingAuthorizationHeader() throws IOException, ServletException {
        authTokenFilter.doFilterInternal(request, response, filterChain);
